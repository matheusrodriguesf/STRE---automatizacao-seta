...
void loop()
{
  ...
  double dT;
  accel_t_gyro_union accel_t_gyro;
  if(accel_t_gyro.value.z_gyro >=2 && accel_t_gyro.value.z_gyro <= 50 ){
  digitalWrite(LEDDIREITO, LOW);
  digitalWrite(LEDESQUERDO, LOW);
  }
  if(accel_t_gyro.value.z_gyro <= -100 ){
    digitalWrite(LEDDIREITO, HIGH);   // turn the LED on (HIGH is the voltage level)
    delay(500);                       // wait for a second
    digitalWrite(LEDDIREITO, LOW);    // turn the LED off by making the voltage LOW
    delay(500);
    digitalWrite(LEDDIREITO, HIGH);   // turn the LED on (HIGH is the voltage level)
    delay(500);                       // wait for a second
    digitalWrite(LEDDIREITO, LOW);    // turn the LED off by making the voltage LOW
  ...
  if(accel_t_gyro.value.z_gyro >=100){
    digitalWrite(LEDESQUERDO, HIGH);   // turn the LED on (HIGH is the voltage level)
    delay(500);                       // wait for a second
    digitalWrite(LEDESQUERDO, LOW);    // turn the LED off by making the voltage LOW
    delay(500);
    digitalWrite(LEDESQUERDO, HIGH);   // turn the LED on (HIGH is the voltage level)
    delay(500);                       // wait for a second
    digitalWrite(LEDESQUERDO, LOW);    // turn the LED off by making the voltage LOW
